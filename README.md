...
Download and install MSI: (Optional):  <https://classic.yarnpkg.com/latest.msi>
...
In the same directory where you installed **Hardhat** add a `hardhat.config.ts` (we are going to use typescript and the Solidity 0.8.11 compiler)
